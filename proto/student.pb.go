...
type Student struct {
	...
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`       // campo 1
	Name          string                 `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`   // campo 2
	Email         string                 `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"` // campo 3
	Age           int32                  `protobuf:"varint,4,opt,name=age,proto3" json:"age,omitempty"`    // campo 4
...
var file_proto_student_proto_rawDesc = string([]byte{
	...
	0x64, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x1f, 0x5a, 0x1d,
	0x70, 0x6c, 0x61, 0x74, 0x7a, 0x69, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x67, 0x6f, 0x2f, 0x67, 0x72,
	0x70, 0x63, 0x3b, 0x73, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x65, 0x70, 0x64, 0x62, 0x06, 0x70,
